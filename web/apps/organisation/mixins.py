...
class LoginMixin(object):
    ...
    def get_info(self, key):
        ...
        return {'key': organisation_request.unique_key, 'data': organisation_request.data, 'status': organisation_request.status, 'is_subscribe': organisation_request.is_subscribe, 'auth_token': organisation_request.auth_token, 'data': organisation_request.data,
